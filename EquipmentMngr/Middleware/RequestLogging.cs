    ...
    internal class RequestLoggingMiddleware
    {
        ...
        public async Task Invoke(HttpContext httpContext)
        {
            ...
            try
            {
                ...
                when (LogCompletion(httpContext, collector, 500,
        ...
        private bool LogCompletion(HttpContext httpContext, DiagnosticContextCollector collector, int statusCode,
            double elapsedMs, Exception ex)
        {
        ...
        private static string GetPath(HttpContext httpContext)
        {
            ...
            */
            ...
            if (string.IsNullOrEmpty(requestPath)) requestPath = httpContext.Request.Path.ToString();
