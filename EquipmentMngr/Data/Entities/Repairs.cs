...
{
    public class Repairs : Infrastructure.Repositories.IAuditable
    {
        [Key]
        ...
        public string FriendlyAddress => string.IsNullOrWhiteSpace(StreetAddress1) ? $"{City}, {States.Abbreviation}, {Zip}" :
        ...
        [InverseProperty(nameof(Entities.State.Repairs))]
        ...
        [Display(Name = "Replacement Serial")]
        ...
        [Display(Name = "Updated On")] public DateTime? UpdatedOn { get; set; }
